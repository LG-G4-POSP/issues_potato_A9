...
echo "78e5cf520d0de4a413ef1cfa7bbbe713 should be the md5" | tee -a log_vs986_usu.txt
...
echo "78e5cf520d0de4a413ef1cfa7bbbe713 should be the md5" | tee -a log_h810_usu.txt
...
echo "78e5cf520d0de4a413ef1cfa7bbbe713 should be the md5" | tee -a log_h811.txt
...
echo "78e5cf520d0de4a413ef1cfa7bbbe713 should be the md5" | tee -a log_h812_usu.txt
...
echo "d1f6fe863643b1e8d1e597762474928c should be the md5" | tee -a log_h815.txt
...
echo "d1f6fe863643b1e8d1e597762474928c should be the md5" | tee -a log_h815_usu.txt
